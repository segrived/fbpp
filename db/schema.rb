...
ActiveRecord::Schema.define(:version => 20130529020719) do
  ...
  add_index "lecturers", ["department_id"], :name => "index_lecturers_on_departament_id"
  ...
  add_index "subjects", ["department_id"], :name => "index_subjects_on_departament_id"
